      ...
      <div className="relative bg-bm1-800 overflow-hidden">
        {this.state.successSend ? 
          <Notification 
            ...
            description="Our support team will be comunicate with you, thank you"
            type="success"
          />
          :
          ''
        ...
        {this.state.errorSend ? 
          <Notification 
            title="Error to send Quote"
            description="An error was generated while submitting the request. Try again!"
            type="error"
          />
          :
          ''
                ...
                <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex">
                  <div>
                    <a href="#"
                      ...
                      <span
                        className="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-bm2-400 rounded-full">What's new</span>
                      <span className="ml-4 text-sm">Just shipped our new Dashboard</span>
                    ...
                    <h1 className="text-4xl tracking-tight font-extrabold text-white sm:leading-none lg:text-5xl xl:text-6xl sm:mt-5 sm:text-6xl lg:mt-6 ">
                      <span className="md:block">Institutional grade</span>{' '}
                      <span className="md:block">OTC Trading</span>
                    </h1>
                    <p className="mt-3 text-base text-gray-100 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      Bitmotto OTC provides easy access to 24/7 liquidity to a range of crypto assets for crypto-to-fiat, fiat-to-crypto transactions.
                    </p>
                    <p className="mt-8 text-sm text-white uppercase tracking-wide font-semibold sm:mt-10">We support</p>
                ...
                <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
                  ...
                  <form className="pt-6" method="POST">
                      <div className="space-y-6 px-10">
                        <div>
                          <h1 className="md:text-2xl font-extrabold text-gray-700">Let's get started</h1>
                          <p className="text-sm text-gray-500 mt-1">Fill the form below and our team will contact you shortly to get you onboard</p>
                        </div>
                        <div>
                        ...
                        <div>
                          <RadioGroup value={this.state.wantToOptions} onChange={option => this.handleWaToOptions(option)}>
                            <RadioGroup.Label className="block text-sm font-medium text-gray-600">I want to</RadioGroup.Label>
                        ...
                        <div>
                          <label htmlFor="amount" className="block text-sm font-medium text-gray-700">Amount of { this.state.selectedCryptocurrency.name } in EUR</label>
                          ...
                          <span className="text-indigo-500 text-xs">Minimum order size: €5000.00</span><br/>
                          <span className={`
                          ...
                          <span className={`
                              ...
                              Remember minimum order size is €5000.00
                          </span>
                        </div>
                            ...
                            <div className="relative flex items-start">
                              ...
                              <div className="ml-3 text-xs">
                                <label htmlFor="comments" className="text-gray-500">
                                  Opt-in to receive email updates from Bitmotto about its products, events, and resources. You can opt out at any time.
                                </label>
                              </div>
                            </div>
                          </fieldset>
